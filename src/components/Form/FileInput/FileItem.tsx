...
const fileItem = tv({
  // base: 'group relative flex flex-1 items-start gap-4 rounded-lg border border-zinc-200 p-4',
  slots: {
    container:
      'group relative flex flex-1 items-start gap-4 rounded-lg border border-zinc-200 p-4',
